...
_part3_data = _safe.import_module("part3", "get_user_repo", "get_signal_repo", "get_payment_repo", "db_manager")
_part5_data = _safe.import_module("part5", "get_market", "get_coinex", "get_signal", "get_ticker", "get_price", "get_ohlcv_data", "get_market_summary")
...
get_user_repo = _part3_data.get("get_user_repo")
get_signal_repo = _part3_data.get("get_signal_repo")
get_payment_repo = _part3_data.get("get_payment_repo")
db_manager = _part3_data.get("db_manager")
get_market = _part5_data.get("get_market")
get_coinex = _part5_data.get("get_coinex")
get_signal_func = _part5_data.get("get_signal")
get_ticker_func = _part5_data.get("get_ticker")
get_price_func = _part5_data.get("get_price")
get_ohlcv_func = _part5_data.get("get_ohlcv_data")
get_market_summary_func = _part5_data.get("get_market_summary")
